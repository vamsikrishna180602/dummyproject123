function createCard(name,brand,price,isAccessory,preview ){
...
for( var i = 0 ; i < productList.length ; i++ ){
  createCard( productList[i].name , productList[i].brand,
  productList[i].price , productList[i].isAccessory , productList[i].preview )
